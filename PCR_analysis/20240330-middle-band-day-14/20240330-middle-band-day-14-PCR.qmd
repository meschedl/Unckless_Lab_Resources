---
title: "20240330-middle-band-day-14-PCR"
format: gfm
editor: visual
---
...
knitr::opts_chunk$set(dpi=300,fig.width=5, fig.height = 5)
```
...
These samples are only the flies who were still alive on the day 14 mark in both replicates of the middle band male dilution infections 
```{r}
