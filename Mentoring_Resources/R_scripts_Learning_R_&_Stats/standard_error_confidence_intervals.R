...
# the output of this is 7.19
# this means that the precision around the mean of average egg counts for age 2
# (60.7 eggs, calculated in the previous script) is + or - 7.19 eggs 
# or 60.7 ± 7.19 eggs 
...
age_2_interval <- 7.19 * 2
mean_age_2 <- 60.2

# then you can do the math with the values
mean_age_2 + age_2_interval
mean_age_2 - age_2_interval
# The approximate 95% confidence interval for egg counts for flies age 2 is 45.82 - 74.58 eggs 

# flies age 3
age_3_interval <- 7.4 * 2
mean_age_3 <- 83.5 

mean_age_3 + age_3_interval
mean_age_3 - age_3_interval
# the approximate 95% confidence interval for egg counts for flies age 3 is 68.7 - 98.3 eggs 
